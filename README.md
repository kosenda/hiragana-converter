> [!NOTE]
> The API used will be out of service on March 3, 2025, so the main functionality of this app is no longer available and cannot be used in the store.
> Therefore, this app will not be modified in the future.
